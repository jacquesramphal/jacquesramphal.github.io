          ...
          <div class="chat-floating-actions">
            <nav class="chat-nav">
              <div class="chat-nav-left">
                ...
                <h5 class="subtle chat-header-title">Ask about his work</h5>
              </div>
...
export default {
  ...
  props: {
    ...
    webhookUrl: {
      type: String,
      default: 'https://jacquesramphal-github-io.vercel.app/api/chat',
    },
    metadata: {
      type: Object,
      default: () => ({}),
...
@media (max-width: 768px) {
  ...
  /* Safeguard: the desktop icon FAB (the chat bubble) must never appear on
     ...
     "Ask about his work" bar is the only mobile entry point. This backs up the
