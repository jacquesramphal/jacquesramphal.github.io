...
#### Design Systems, AI-Guarded Pipeline, Cross-Functional Tooling

![Finding my lane](../images/placeholders/placeholder-25.svg)


<table>
  <tr><td><strong>Role</strong></td><td>Sole Designer & Developer</td></tr>
  <tr><td><strong>Scope</strong></td><td>Multi-display Human-Machine Interface (HMI) — Cluster, Central, Passenger</td></tr>
