...
Load the system prompt from `audit/guides/consolidate-prompt.md`.
...
- Consolidation prompt: `audit/guides/consolidate-prompt.md`
- Column schema: `audit/guides/config.md`
- Webhook contract: `scripts/audit/apps-script/Code.gs` → `appendConsolidationRows()` (called from Step 7, not here)
