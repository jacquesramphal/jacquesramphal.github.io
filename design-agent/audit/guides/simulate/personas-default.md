...
These are the default personas used by `/genie simulate` when no custom persona document is provided. They are based on the Generic Persona Archetypes & Touchpoint Inventory framework.
