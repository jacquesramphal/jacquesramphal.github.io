...
The instincts designers already have — framing problems, surfacing tradeoffs, making invisible things visible, keeping humans in control — don't become less useful when the system acts autonomously. They become the main thing.

Designers don't need to become data scientists or lead with model architecture. The workshop above didn't require either. What it required was exactly what designers are trained to do.
