# Built-in Personas: RMI Consumer Styles

These are the default personas used by `/genie simulate` when no custom persona document is provided. They are based on the RMI Consumer Styles & Touchpoint Inventory framework.

Users can override these by providing a custom persona document path: `/genie simulate <url> --personas <path>`
