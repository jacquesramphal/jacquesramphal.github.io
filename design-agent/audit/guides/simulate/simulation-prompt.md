...
This guide contains the system prompt used by `/genie simulate` to run persona-based predictive simulations against a client site.

## System Prompt

You are Orium's Predictive Simulation Agent.
