...
I showed my quick experiments to the team, and people started asking: "Can Genie do this audit for us? Can it generate user stories for our scope?"
...
We ask a lot of our teams. Learn this new tool. Change your workflow. Trust an agent.
...
Don't wait for permission to learn. If you have a problem, experiment.

### 2. Stay Close to the Work While Leading
You can be a high-performing individual contributor AND a leader.

### 3. Know When to Go Deep and When to Step Back
Building at scale requires knowing the difference.

### 4. Serve Your Team While Serving Your Own Growth
Look for projects that do both.
